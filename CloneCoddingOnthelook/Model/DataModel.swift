...
//            .init(profile: testProfiles[0], image: "card02", comment: "blabla", cloths: [Cloth(name: "남성 셰틀랜드 울 싱글 벤트 스포츠 재킷 - 네이비", brand: "THOM BROWNE", price: "1,081,000", image: "cloth01", size: "3", url: "https://www.musinsa.com/app/goods/2835447")], bookMarked: true, liked: true),
...
//            .init(profile: testProfiles[4], image: "card05", comment: "blabla", cloths: [], liked: true)
//        ]
//        self.profiles = [
...
//    }
//    
//    func getProfilesSet() -> Set<Profile> {
//        var resultSet = Set<Profile>()
//        
//        for card in self.cards {
//            if resultSet.contains(card.profile) {
//                continue
//            } else {
//                resultSet.insert(card.profile)
//            }
//        }
//        
//        return resultSet
