...
class Cards: ObservableObject {
    @Published var cards: [Card] = [
        .init(profile: myProfile, image: "card01", comment: "This is comment", cloths: [Cloth(name: "루키 언스트럭쳐 볼캡 LA다저스", brand: "MLB", price: "36000", image: "nycCap", size: "FREE", url: "https://www.musinsa.com/app/goods/1214109"), Cloth(name: "[3M 신슐레이트]오리지널 M-1965 피쉬테일 파카", brand: "LAFUDGESTORE", price: "148000", image: "clothImage", size: "M", url: "https://www.musinsa.com/app/goods/2064478"), Cloth(name: "Nike x J.Crew Killshot 2 Lucid Green", brand: "NIKE", price: "63000", image: "shoose", url: "https://kream.co.kr/products/23500")], bookMarked: false),
