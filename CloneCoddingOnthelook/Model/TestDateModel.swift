...
class TestDataModel: ObservableObject {
    ...
    init() {
        ...
        self.cards = [
            .init(id: "card01", profileId: "01_sbigstar0332", image: ["card01-2", "card01"], comment: "This is comment", clothsId: ["01", "02", "03"], bookMarked: false),
            .init(id: "card02", profileId: "01_sbigstar0332", image: ["card02", "card01", "card01-2"], comment: "blabla", clothsId: ["04"], bookMarked: true, liked: true),
